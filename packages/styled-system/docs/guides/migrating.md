...
| `layout`     | `width`, `height`, `minWidth`, `minHeight`, `maxWidth`, `maxHeight`, `display`, `verticalAlign`, `aspectRatio`, `size`                                                                                                                                                                                     |
| `typography` | `fontFamily`, `fontSize`, `fontWeight`, `lineHeight`, `letterSpacing`, `fontStyle`, `textAlign`, `textTransform`, `textAlignLast`, `textDecoration`, `textDecorationLine`, `textDecorationStyle`, `textDecorationThickness`, `textDecorationColor`                                                         |

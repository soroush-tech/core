export const forestGreen = {
  ...
  100: '#cffccf', // Pale mist
  200: '#72ff71', // Vivid lime (secondary-fixed)
...
export const _title = 'Forest Green'
export const _description = `
  Name: Forest / Organic / Deep Green
  Hue Bias: Saturated mid-green, earthy and natural
  Category: Primary brand, nature accent
  Mood: Grounded, organic, structured
`

export const _notes = {
  100: 'Pale mist',
  200: 'Vivid lime (secondary-fixed)',

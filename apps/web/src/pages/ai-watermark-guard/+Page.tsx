...
// ai-watermark-guard lives in its own repository, so there is no `packages/` README to import.
// This page carries its own, written for the site and kept shorter than the package's.
import readme from './ai-watermark-guard.readme.md?raw'
import { hero } from './ai-watermark-guard.data'

function AiWatermarkGuardPage() {
  return (
    <Layout>
      <PackageHero {...hero} />
...
export default AiWatermarkGuardPage
